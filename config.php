...
try {
    ...
    $migrations = [
        ...
        'orders1' => [
            ...
            'pickup_lat' => "ALTER TABLE orders1 ADD COLUMN pickup_lat DECIMAL(10,8) DEFAULT NULL AFTER address",
            'pickup_lng' => "ALTER TABLE orders1 ADD COLUMN pickup_lng DECIMAL(11,8) DEFAULT NULL AFTER pickup_lat",
            'dropoff_lat' => "ALTER TABLE orders1 ADD COLUMN dropoff_lat DECIMAL(10,8) DEFAULT NULL AFTER pickup_lng",
            'dropoff_lng' => "ALTER TABLE orders1 ADD COLUMN dropoff_lng DECIMAL(11,8) DEFAULT NULL AFTER dropoff_lat",
            'distance_km' => "ALTER TABLE orders1 ADD COLUMN distance_km DECIMAL(6,2) DEFAULT NULL AFTER dropoff_lng",
    ...
    if ($check_users == 0) {
        ...
        $conn->prepare("INSERT INTO users1 (username, password, role, points, status, full_name, phone_verified) VALUES (?, ?, ?, ?, 'active', ?, 1)")
